...
Ext.define('CalendarApp', {
    ...
    constructor : function() {
        ...
        var M = Ext.calendar.data.CalendarMappings;
    	...
    	this.eventStore = Ext.create('DirectEventStore');
    	this.calendarStore = Ext.create('DirectCalendarStore');
