        ...
        me.columns = {
            ...
            items: [
                ...
                },
                {
                    ...
                    width: 24,
                    icon: 'https://static.rasc.ch/ext-5.1.4.257/examples/simple-tasks/resources/images/edit_task.png',
                    iconCls: 'x-hidden',
                    tooltip: 'Edit',
                    menuDisabled: true,
                    sortable: false,
                ...
                },
                {
                    ...
                    width: 24,
                    icon: 'https://static.rasc.ch/ext-5.1.4.257/examples/simple-tasks/resources/images/delete.png',
                    iconCls: 'x-hidden',
                    tooltip: 'Delete',
                    menuDisabled: true,
                    sortable: false,
