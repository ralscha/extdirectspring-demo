    ...
    rowBodyTpl: [
        '<div class="text-wrapper">',
            '<div class="news-data">',
                ...
                '<div class="news-toggle collapse"><span>COLLAPSE</span><img src="//demo.rasc.ch/resources/ext-5.1.1.226/examples/executive-dashboard/resources/icons/collapse-news.png"></div>',
            '</div>',
        '</div>'
    ],
