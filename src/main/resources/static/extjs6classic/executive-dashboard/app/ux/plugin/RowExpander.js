    ...
    rowBodyTpl: [
        '<div class="text-wrapper">',
            '<div class="news-data">',
                ...
                '<div class="news-toggle collapse"><span>COLLAPSE</span><img src="https://static.rasc.ch/ext-6.0.3.109/build/examples/classic/executive-dashboard/resources/icons/collapse-news.png"></div>',
            '</div>',
        '</div>'
    ],
