    ...
    rowBodyTpl: [
        '<div class="text-wrapper">',
            '<div class="news-data">',
                ...
                '<div class="news-toggle collapse"><span>COLLAPSE</span><img src="//demo.rasc.ch/resources/ext-6.0.2.119/build/examples/classic/executive-dashboard/resources/icons/collapse-news.png"></div>',
            '</div>',
        '</div>'
    ],
