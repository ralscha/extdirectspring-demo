Ext.define('ExecDashboard.view.companynews.News', {
    ...
    titleTpl:
        '<div class="text-wrapper">' +
            ...
            '<div class="news-data">' +
                '<div class="news-picture"><img src="//demo.rasc.ch/resources/ext-6.0.2.168/build/examples/classic/executive-dashboard/resources/icons/{image}"></div>' +
                '<div class="news-content">' +
                    '<div class="news-title">{title}</div>' +
                    '<div class="news-small">by <span class="news-author">{author}</span>' +
                    '<img src="//demo.rasc.ch/resources/ext-6.0.2.168/build/examples/classic/executive-dashboard/resources/icons/cal-icon.png"/>{date}' +
                    '<img src="//demo.rasc.ch/resources/ext-6.0.2.168/build/examples/classic/executive-dashboard/resources/icons/clock-icon.png"/>{time}</div>' +
                    ...
                    '<img src="//demo.rasc.ch/resources/ext-6.0.2.168/build/examples/classic/executive-dashboard/resources/icons/expand-news.png"></div>' +
                '</div>' +
            '</div>' +
        '<div>',
